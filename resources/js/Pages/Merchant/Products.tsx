                    ...
                    <div className="mx-auto grid w-full max-w-[1580px] gap-6 xl:grid-cols-[minmax(260px,320px)_minmax(0,1fr)] xl:gap-8">
                        ...
                        <section className="min-w-0 space-y-6">
                            <header className="rounded-3xl border border-black/10 bg-white p-5 shadow-xl shadow-black/5 sm:p-8">
                                ...
                                <h1 className="mt-3 text-3xl font-semibold text-slate-900 sm:text-4xl">Mes produits</h1>
                                        ...
                                        <article key={product.id} className="rounded-3xl border border-black/10 bg-white p-6 shadow-sm">
                                            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                                <div className="min-w-0">
                                                    ...
                                                    <h2 className="mt-1 break-words text-xl font-semibold text-slate-900">{product.name}</h2>
                                                </div>
                                                <div className="flex flex-wrap items-center gap-3 sm:justify-end">
                                                    ...
                                                    <Link href={`/merchant/products/${product.id}/edit`} className="inline-flex min-h-10 items-center justify-center rounded-full border border-black/10 bg-black px-4 py-2 text-sm font-semibold text-white">
                                                        Modifier
                                                    </Link>
                                                </div>
                                            </div>
